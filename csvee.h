...
void csvee_add_row(Csvee_t *csvee, size_t fields_count, ...);
...
void csvee_print_csv(const Csvee_t *file);
...
public:
    ...
    {
        return std::string(m_Csvee_t.rows->fields->value);
    };
