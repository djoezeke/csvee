...
#define CSVEE_CLANG_SUPPRESS_WARNING(w) CSVEE_PRAGMA_TO_STR(clang diagnostic ignored w)
...
#define CSVEE_GCC_SUPPRESS_WARNING(w) CSVEE_PRAGMA_TO_STR(GCC diagnostic ignored w)
